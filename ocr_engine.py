            ...
            if self.model_det_dir and self.model_rec_dir:
                if os.path.exists(self.model_det_dir) and os.path.exists(self.model_rec_dir):
                    ...
                    params_list.append({
                        ...
                        "device": device,
                        # PaddleOCR 3.x defaults this to True at the pipeline
                        # level, which overrides the FLAGS_use_mkldnn env flag.
                        # On Windows/CPU that path can crash while converting
                        # PIR attributes to OneDNN runtime attributes.
                        "enable_mkldnn": False,
                        "enable_hpi": False,
